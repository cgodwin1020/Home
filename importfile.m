%for importing the average signal files for DMN and TPN

function [VarName1,extra,voxels] = importfile(filename, startRow, endRow) %, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   [VARNAME1,6380,VOXELS] = IMPORTFILE1(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   [VARNAME1,6380,VOXELS] = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [VarName1,6380,voxels] = importfile1('DMN1_avg_M87103162.txt',1, 143);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/01/23 01:38:24
...
extra = cell2mat(rawNumericColumns(:, 2));
voxels = rawCellColumns(:, 1);
